...
task :notifier do
  ...
  start_at = king_of_time.search('table')[1].search('tr')[4].search('td')[4].search('div').text.gsub(/\r\n|\s| /,'')
  end_at = king_of_time.search('table')[1].search('tr')[4].search('td')[5].search('div').text.gsub(/\r\n|\s| /,'')
